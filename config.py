...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "6821953802:AAE78SV72CnY6cnP8sj6ghRatZo1VAPJSag")  # Bot token from @BotFather
ADMINS = (
...
DATABASE_URL = os.environ.get(
    "DATABASE_URL", "mongodb+srv://BIGBOSS:BIGBOSS@cluster0.ii3gmvr.mongodb.net/?retryWrites=true&w=majority")  # mongodb uri from https://www.mongodb.com/
OWNER_ID = int(os.environ.get("OWNER_ID", "6459102722"))  # id of the owner
ADMINS.append(OWNER_ID) if OWNER_ID not in ADMINS else []

#  Optionnal variables
LOG_CHANNEL = int(
    os.environ.get("LOG_CHANNEL", "-1002134940898")
...
BASE_SITE = os.environ.get("BASE_SITE", "zxlink.in")
